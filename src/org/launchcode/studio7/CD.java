...
public class CD extends BaseDisc implements OpticalDisc{
    ...
    public CD(String name, double diameter, String color, boolean isEdible, boolean isNormallyThrown){
    ...
    public void spinDisc() {
        System.out.println("The user entered the " + getName() + " CD into the player and it spins at " + this.spinsPerMinute + " rotations per minute." );
    }

    @Override
    public void readData() {
        System.out.println("The " + getName() + " CD outputs " + this.formatStoredOnDisc + ".");
    }
